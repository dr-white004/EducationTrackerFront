  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        setError("Error fetching books to read later. Please try again.");
      } finally {
        setLoading(false);
      }
    };
  ...
  useEffect(() => {
    const fetchFav = async () => {
      try {
        ...
        setError("Error fetching favorite book. Please try again.");
      }
    };
    fetchFav();
  }, [auth.access]);
      ...
      <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white py-16">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-4xl mx-auto">
            <h1 className="text-4xl md:text-5xl font-bold mb-4">Books to Read Later</h1>
            <p className="text-xl md:text-2xl text-blue-100 mb-8">
              Plan your reading journey with your curated list
            </p>
        ...
        <div>
          {loading ? (
            <div className="flex flex-col items-center justify-center py-20">
              ...
              <p className="mt-4 text-lg text-gray-600">Loading your books to read later...</p>
            </div>
            ...
            <div className="text-center py-20">
              <div className="max-w-md mx-auto">
                ...
                <h3 className="mt-4 text-lg font-medium text-gray-900">
                  {searchTerm || filterBy === 'favorites' ? 'No books found' : 'No books planned yet'}
                </h3>
                <p className="mt-2 text-gray-500">
                  {searchTerm || filterBy === 'favorites'
                    ? 'Try adjusting your search or filter criteria.'
                    : 'Add books you plan to read to start your list.'}
                </p>
              </div>
            </div>
          ) : (
            <>
              <div className="flex justify-between items-center mb-8">
                <h2 className="text-2xl font-bold text-gray-900">
                  {filterBy === 'favorites' ? 'Your Favorite Books to Read Later' : 'Books to Read Later'}
